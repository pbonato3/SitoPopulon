...
'description' => 'Aggiungi una notizia',
...
print $page->div({-class => 'breadcrumbs'}, a({-name => 'saltamenu'}), strong("Ti trovi in: "), a({-href => 'Notizie.cgi'}, "Notizie"), "&gt &gt Aggiungi Notizia"), "\n";
